 ...
 * [mamo.yml](mamo.yml)
     * Determines how your purl.obolibrary.org/obo/mamo/ redirects will be handled
     ...
     * Paste in the contents of [mamo.yml](mamo.yml)
 ...
 * [mamo.md](mamo.md)
     ...
     * Paste in the contents of [mamo.md](mamo.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
